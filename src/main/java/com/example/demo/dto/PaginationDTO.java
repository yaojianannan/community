...
public class PaginationDTO {
     ...
     private List<Integer> pages = new ArrayList<>();//当前页面所展示的页码数组
     ...
     public void setPagination(Integer totalCount, Integer page, Integer size) {
       ...
       showNext = (page.equals(totalPage)) ? false : true;
        ...
        //是否展示第一页
        showFirstPage = (pages.contains(1) || totalPage == 0) ? false : true;

        //是否展示最后一页
        showEndPage = (pages.contains(totalPage) || totalPage == 0) ? false : true;
